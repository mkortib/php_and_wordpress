	...
	<div class="container">
		...
		<div class="flexreview">
		  <ul class="slides">
			<?php
			wp_reset_query();
			$recent_testimonials = new WP_Query(array('post_type'=>'testimonials','posts_per_page'=>2));
	...
	<h3>Our blog</h3>
		...
		if ( $recent_list->have_posts() ) :
			...
			<div class="blog-item">
				...
				<span><?php echo get_the_date(); ?></span><span><i class="fa fa-comment"></i><?php echo get_comments_number(get_the_ID()); ?></span>
			</div>
